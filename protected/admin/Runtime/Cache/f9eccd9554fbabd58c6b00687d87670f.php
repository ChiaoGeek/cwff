...
<div id="container">
			...
			<div id="upload">
			 <form action="?m=Index&a=m2_add" name="form1" id="form1" method="post" enctype="multipart/form-data">
             <!--表单隐藏-->
             ...
             <!--表单隐藏-->
				<div id="upload_title" class="upload_class">
 				...
 				<div id="upload_time" class="upload_class">
                    上传时间：<input type="text" class="up_input" name="createtime" id="time" value="<?php echo ($value["createtime"]); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" size="40">
                </div>
                <div id="upload_picture" class="upload_class">
                    ...
                    <font color="red">此项为必须项图片宽比高为3:2</font>
                     <?php if(($flag == 'updata')): ?><img src="__ROOT__<?php echo (substr($value["thumb_path"], 1)); echo ($value["thumb_name"]); ?>" width="45px" height="30px" alt="" /><?php endif; ?>
                </div>
				...
				<div id="upload_button" class="upload_class"> 
                    <?php if(($flag == 'updata')): ?><input type="submit" name="updata" id="submit" value="修改">
