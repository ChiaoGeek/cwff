...
<div class="subnav">
    ...
    <div class="content-menu ib-a blue line-x">
        <a href='javascript:;' class="on"><em>系统栏目管理</em></a><span>|</span><a class="aadd" name="none"><em>添加栏目</em></a></div>
</div>
<style type="text/css">
...
<div class="table-list">
    <table width="100%" cellspacing="0" >
        <thead>
            <tr>
            <th width="80">id</th>
            <th align='left' width='150'>栏目中文名称</th>
            <th align='left' width='150'>栏目拼音</th>
            <th align='left' width="150">栏目所属级别ID</th>
            <th align='left' width="150">栏目模型</th>
            <th align='left' width="150">列表下文章模型</th>
            <th >管理操作</th>
            </tr>
        </thead>
    <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td ><?php echo ($vo["cn_name"]); ?></td>
                    <td ><?php echo ($vo["en_name"]); ?></td>
                    <td ><?php echo ($vo["p_id"]); ?></td>
                    <td><?php echo ($vo["model_type"]); ?></td>
                    <td><?php echo ($vo["article_type"]); ?></td>
                    <td align='center' > <a class="aadd" style="cursor:pointer;" name="<?php echo ($vo["id"]); ?>">修改</a> | <a href="javascript:confirmurl('?m=Index&a=m3_sub1_delete&id=<?php echo ($vo["id"]); ?>','确认要删除吗？')">删除</a> </td>
...
//-->
    $('.aadd').on('click', function(){
            ...
            if (id == 'none') {
                        ...
                        shade: 0.8,
                        area: ['700px', '50%'],
                        content: '?m=Index&a=m3_sub1_add', //iframe的url
                        //content: 'http://job.nedu.edu.cn', //iframe的url
                        end:function(){
                            window.location.href='?m=Index&a=m3_sub1';
                        }    
                }); 
            }else{
                        layer.open({
                        ...
                        shade: 0.8,
                        area: ['700px', '50%'],
                        content: '?m=Index&a=m3_sub1_add&id='+id, //iframe的url
                        end:function(){
                            window.location.href='?m=Index&a=m3_sub1';
                        }    
                }); 
